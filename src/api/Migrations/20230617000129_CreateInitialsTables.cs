...
{
    public partial class CreateInitialsTables : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IdTitular = table.Column<long>(type: "bigint", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PerfilUsuario_Empresa_IdEmpresa",
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PerfilUsuario_Pessoa_IdTitular",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PerfilUsuario_IdEmpresa",
                schema: "cadastro",
                table: "PerfilUsuario",
                column: "IdEmpresa");

            migrationBuilder.CreateIndex(
                name: "IX_PerfilUsuario_IdTitular",
                schema: "cadastro",
                table: "PerfilUsuario",
                column: "IdTitular");
